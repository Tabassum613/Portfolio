...
function Login() {
  ...
  <div className="modal-box">
    ...
    <div className="flex justify-around mt-4">
        <button className="bg-pink-600 text-white rounded-md px-3 py-1 hover:bg-pink-800">Login</button>

        
        <p>Not registered? 
            <Link to="/signup" className="underline text-blue-500">Signup</Link> </p>
